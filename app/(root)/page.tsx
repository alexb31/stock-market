    ...
    <div className='flex min-h-screen home-wrapper'>
      ...
      <section className='grid w-full gap-8 home-section'>
        <div className='h-full md:col-span-1 xl:col-span-1'>
          <TradingViewWidget title='Market Overview' scriptUrl={`${scriptUrl}timeline.js`} config={TOP_STORIES_WIDGET_CONFIG} className='custom-chart' height={600} />
        </div>
        <div className='h-full md:col-span-1 xl:col-span-2'>
          <TradingViewWidget title='Stock Heatmap' scriptUrl={`${scriptUrl}market-quotes.js`} config={MARKET_OVERVIEW_WIDGET_CONFIG} className='custom-chart' height={600} />
        </div>
      </section>
    </div>
  )
